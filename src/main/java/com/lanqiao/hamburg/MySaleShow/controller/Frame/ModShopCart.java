...
public class ModShopCart extends JFrame {
    ...
    private void initComponents() throws SQLException {
        ...
        button2.addActionListener(a->{
            int rowNo = table1.getSelectedRow();//获取行对象
            ...
            ShopCar shopCar = new ShopCar(colnum,id,price,num,user_id,name,title);//创建购物车对像
    ...
    private String head[] = {"序列","ID","促销价","数量","用户ID","姓名:","商品名:"};
